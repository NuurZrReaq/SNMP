...
public class SnmpAgent extends BaseAgent {
     ...
     private static OID sys = new OID(".1.3.6.1.2.1.1");
...
52
    ...
    public static void main(String[] args) {
        try {
            SnmpAgent snmpAg = new SnmpAgent("0.0.0.0/10030");
            snmpAg.start();
            ...
            // to test withasus
            snmpAg.registerManagedObjects((SnmpAgent.createReadOnly(sysDesc,"Asus ZenBook for Noor Zreaq")));
            snmpAg.registerManagedObjects((SnmpAgent.createReadOnly(sysObjID,sys)));
            snmpAg.registerManagedObjects((SnmpAgent.createReadOnly(sysUptime,new Timestamp(System.currentTimeMillis()).toString())));
            snmpAg.registerManagedObjects((SnmpAgent.createReadOnly(sysCont,"none")));
            snmpAg.registerManagedObjects((SnmpAgent.createReadOnly(sysName," Noor Zreaq")));
            snmpAg.registerManagedObjects((SnmpAgent.createReadOnly(sysLoc,"none")));
            snmpAg.registerManagedObjects((SnmpAgent.createReadOnly(sysServ,new Integer32(75))));
